...
public:
	FStageData() : Song(nullptr), SongName(TEXT("")), Bpm(0), SongLength(0), MaxPurificationFailureCount(0),CameraSpeed(1),bIsPurifyActive(true), StageMaxScore(0){
	}
...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (AllowPrivateAccess = "true"))
	float GetStageMaxScore(EStageIndex StageIndex) { return StageData[StageIndex].StageMaxScore; }
	...
	UFUNCTION(BlueprintCallable, meta = (AllowPrivateAccess = "true"))
	float GetThreshold_S() const { return Threshold_S; }
	UFUNCTION(BlueprintCallable, meta = (AllowPrivateAccess = "true"))
	float GetThreshold_A() const { return Threshold_A; }
	UFUNCTION(BlueprintCallable, meta = (AllowPrivateAccess = "true"))
	float GetThreshold_B() const { return Threshold_B; }
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "ScoreThreshold")
	int Threshold_S;
	UPROPERTY(EditAnywhere, Category = "ScoreThreshold")
	int Threshold_A;
	UPROPERTY(EditAnywhere, Category = "ScoreThreshold")
