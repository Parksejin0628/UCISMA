...
protected:
	...
	// 대미지 입었을때 행동하는 호출되는 함수
	virtual void HitReaction(float Damage, EJudgementResult JudgementResult);
	void SpawnHitFx(EJudgementResult Judgement);
	void UpdatePlayerRecordOnPerfectHit();
	void UpdatePlayerRecordOnDied();
...
public:
	...
	//Get
	class UEnemyStatComp* GetEnemyStatComp() { return this->EnemyStatComp; }
...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "StatSystem")
	FEnemyAbilityData EnemyAbilityData;
