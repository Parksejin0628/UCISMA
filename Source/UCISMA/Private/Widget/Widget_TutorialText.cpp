...
{
	if (GetVisibility() == ESlateVisibility::Collapsed) SetVisibility(ESlateVisibility::SelfHitTestInvisible);
...
{
	songProcessBarArrow->SetVisibility(ESlateVisibility::Collapsed);
	attackNodeArrow->SetVisibility(ESlateVisibility::Collapsed);
	dashNodeArrow->SetVisibility(ESlateVisibility::Collapsed);
	beatBarArrow->SetVisibility(ESlateVisibility::Collapsed);
	cursorArrow->SetVisibility(ESlateVisibility::Collapsed);
}
...
void UWidget_TutorialText::ChangeStep(ETutorialStep Step)
{
	...
	{
		TutorialStepWidgets[Step]->SetVisibility(ESlateVisibility::SelfHitTestInvisible);
	}
}
