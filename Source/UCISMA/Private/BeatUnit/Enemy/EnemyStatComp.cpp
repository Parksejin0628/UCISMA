...
void UEnemyStatComp::InitHealth(int32 Maxhp)
{
	this->MaxHealth = Maxhp;
	this->CurrentHealth = Maxhp;
}

bool UEnemyStatComp::DecreaseHealth(float value)
{
	CurrentHealth -= value;
...
void UEnemyStatComp::IncreaseHealth(float value)
{
	CurrentHealth += value;
...
bool UEnemyStatComp::IsDead() const
{
