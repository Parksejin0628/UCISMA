...
AVisualRotatorActor* UUBeatRotatorComponent::GetOrCreateVisualizer()
{
	...
	Params.ObjectFlags = RF_Transient; // ���� �ȵ�
...
void UUBeatRotatorComponent::StartRotation()
{
	...
	{
		Alpha = 1.0f;
		GetWorld()->GetTimerManager().ClearTimer(rotateTimerHandle); // ȸ�� ����
	}

	FQuat NewRot = FQuat::Slerp(rotateStartQuat, rotateValueQuat, Alpha); // Quaternion ����
